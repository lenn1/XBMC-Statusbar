...
- (IBAction)button_playPause:(id)sender 
{
    ...
    [self RPCCall:rpc_call]; 
    rpc_call = @"{ \"jsonrpc\": \"2.0\", \"method\": \"Player.PlayPause\", \"params\": [0], \"id\": null}";
    [self RPCCall:rpc_call]; 
...
- (IBAction)button_Next:(id)sender 
{
    ...
    [self RPCCall:rpc_call]; 
    rpc_call = @"{ \"jsonrpc\": \"2.0\", \"method\": \"Player.GoNext\", \"params\": [0], \"id\": null}";
    [self RPCCall:rpc_call]; 
}
...
- (IBAction)button_Previous:(id)sender 
{
    ...
    [self RPCCall:rpc_call]; 
    rpc_call = @"{ \"jsonrpc\": \"2.0\", \"method\": \"Player.GoPrevious\", \"params\": [0], \"id\": null}";
    [self RPCCall:rpc_call]; 
}
...
- (IBAction)button_Stop:(id)sender 
{
    ...
    [self RPCCall:rpc_call]; 
    rpc_call = @"{ \"jsonrpc\": \"2.0\", \"method\": \"Player.Stop\", \"params\": [0], \"id\": null}";
    [self RPCCall:rpc_call]; 
}
